...
common_files = files_cm_iocov & files_original_cm

print("Only in cm_iocov: ", cm_iocov_only)
print("Only in original_cm: ", original_cm_only)
print("Test failures on both branches: ", common_files)

print("Length of cm_iocov bugs: ", len(files_cm_iocov))
print("Length of original_cm bugs: ", len(files_original_cm))
print("Length of cm_iocov only: ", len(cm_iocov_only))
print("Length of original_cm only: ", len(original_cm_only))
print("Length of test failures on both branches: ", len(common_files))
